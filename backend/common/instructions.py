...
SCHEDULING_INSTRUCTION = (
    ...
    "(reshaped to the \"first_attempt.shoot_days\" fields) plus that "
    "first call's \"issues\" verbatim, so the correction is visible, not "
    "silently discarded. If your very first validate_schedule call "
